...
const posterCategoryApi = apiSlice.injectEndpoints({
  ...
  endpoints: (builder) => ({
    ...
    createPosterCategory: builder.mutation<
      { data: { newPosterCategory: IPosterCategory; status: boolean; message: string } },
      IPosterCategory
    >({
      query: (data) => {
        return {
    ...
    deletePosterCategory: builder.mutation<
      { data: { deletedPosterCategory: IPosterCategory; status: boolean; message: string } },
      IPosterCategory
    >({
      query: (id) => {
        return {
